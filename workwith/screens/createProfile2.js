...
class CreateProfile2 extends Component {
 ...
 // alert(text)
    ...
    goToSuggestScreen = () => {
       ...
       if(selectedFruits1) {
             console.log("hiiiiiiiiiiiiiiiiiiiii ",this.state.name,this.state.gender, this.state.birth,this.state.about, this.state.title,this.state.projects,   )
          ...
          this.setState({loading: true});
           ...
           if(this.state.image) {
             photo = {
              ...
              data.append('bio', this.state.about);
              data.append('job_title', this.state.title);
              data.append('project', this.state.projects);
  ...
  onSelectionsChangeTime = (selectedFruits) => {
   ...
   selectedTime=[];
    ...
    render() {
     console.log("renederrrrr",selectedFruits1)
                ...
                <ScrollView>
                    <KeyboardAvoidingView behavior="padding" enabled >
                        <View style={styles.container}>
                           ...
                           { this.state.check == false ||selectedFruits1=='' ?<Text style={{ color: 'white', width: '100%',fontSize:16 }}>Select what you’re looking for</Text>:
                           <Text style={{ color: 'white',fontSize:16 }}>{selectedFruits1.join(', ')}</Text>
                            ...
                            <View style={styles.button_submit}>
                                <TouchableOpacity style={[styles.btn, commonstyle.white_btn]} onPress={this.goToSuggestScreen}>
                                    <Text style={[commonstyle.btn_text, { color: constants.BLUE }, commonstyle.bold_text]}>Submit</Text>
                                </TouchableOpacity>
                            </View>
                            <View style={styles.button_Skip}>
                            <TouchableOpacity style={[styles.btn, commonstyle.white_btn]} onPress={this.DeleteModal}>
                                    <Text style={[commonstyle.btn_text, { color: constants.BLUE }, commonstyle.bold_text]}>Skip</Text>
                                </TouchableOpacity>
                                </View>
